...
import { SupplierRepository } from '../repositories/index';
...
export class ImageUploadController {
    ...
    //         try {
    //             //Now we go get the supplier
    //             const supplier = await new SupplierRepository().single(request.params['id']);
    ...
    //         url: `${Config.active.get('ProductImageURLLocationRoot')}${Config.active.get('SupplierImageBucketName')}/${AmazonS3Service.variationName(type, file)}`,
